...
import { OCPathOperation } from '/assets/client/js/views/oc-path-operation.js'
...
export const pathOperations = path => {
  const linkRelID = path['x-link-rel']

  const operations = operationsForSupportedVerbs(path)
